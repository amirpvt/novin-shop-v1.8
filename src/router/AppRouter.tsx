...
export default function AppRouter({
  ...
  return (
    <Routes>
      ...
      <Route path="/shop" element={<Shop products={products} onProductClick={goProductDetails} onWholesale={goWholesaleRequest} />} />
      ...
      <Route path="/about" element={<AboutPage onBack={() => window.history.back()} onShop={() => goShop()} onOrder={goWholesaleRequest} />} />
